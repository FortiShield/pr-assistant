...
class PRHelpMessage:
    ...
    async def run(self):
        try:
            ...
            base_path = "https://khulnasoft.github.io/pr-assistant/tools"
            ...
            if isinstance(self.git_provider, GithubProvider) and not get_settings().config.get('disable_checkboxes', False):
                ...
                pr_comment += "</table>\n\n"
                pr_comment += f"""\n\n(1) Note that each tool be [triggered automatically](https://github.com/khulnasoft/pr-assistant/blob/main/Usage.md#github-app-automatic-tools-for-pr-actions) when a new PR is opened, or called manually by [commenting on a PR](https://github.com/khulnasoft/pr-assistant/blob/main/Usage.md#online-usage)."""
                ...
                pr_comment += "</table>\n\n"
                pr_comment += f"""\n\nNote that each tool be [invoked automatically](https://khulnasoft.github.io/pr-assistant/usage-guide/automations_and_usage/) when a new PR is opened, or called manually by [commenting on a PR](https://khulnasoft.github.io/pr-assistant/usage-guide/automations_and_usage/#online-usage)."""
